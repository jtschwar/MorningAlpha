            ...
            for t in batch:
                try:
                    ...
                    results.append({
                        ...
                        "DistanceFromHigh": metrics.get('distance_from_high', np.nan),
                        "AvgDrawdown": metrics.get('avg_drawdown', np.nan),
                        "VolumeConsistency": metrics.get('volume_consistency', np.nan),
                        "VolatilityRatio": metrics.get('volatility_ratio', np.nan),
